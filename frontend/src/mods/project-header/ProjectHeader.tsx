	...
	return <>
		<div {...props} className={cn('px-4 py-2 flex flex-row items-start', props.className)}>
			...
			<SolButton shadow='none' theme='neutral_outlined_light' className='!border-0 z-20 mt-2 group relative' depress='down_px'>
				...
				<div className='absolute group-hover:block hidden right-0 w-[200px] top-full z-10 bg-white dark:bg-neutral-900 shadow-sm border border-neutral-200 py-2 px-1 dark:border-neutral-700 rounded-md'>
